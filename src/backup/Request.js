...
class Stages extends React.Component {
  ...
  saveAndContinue = e => {
    const SetForm = {
      ...
      Customer_customername: this.state.customername,
        ...
        <div class="container register-form">
          ...
          <div class="form-content">
            <div class="row">
              <div class="col-md-4">
                <input
                  type="text"  style={{ border: 'transparent', padding: '9%' }}
              ...
              <div class="col-md-4">
    						...
    						<select class="form-control" onChange={this.handleCountryChange} style={{ border: 'transparent', height:"56px"}}>
            ...
            <div class="row" style={{ marginTop: "8%" }}>
              <div class="col-md-4">
                <input
                  type="text" style={{ border: 'transparent', padding: '9%' }}
                  class="form-control data-adds"
                  placeholder="Customer Name"  value={this.state.customername} onChange={this.handleCustomerChange}
                />
              </div>
            </div>
            <div class="row" style={{ marginTop: "8%" }}>
              ...
              <div class="col-md-6">
              <textarea rows="5" class="form-control resize-v post-area"placeholder="Address" value={this.state.address} onChange={this.handleAddressChange}   style={{ border: 'transparent'}}></textarea>
            ...
            <FaArrowRight  onClick={this.setRedirect} style={{marginRight: '2%'}}/>Order
        </div>          </div>
        </div>
      </form>
    );
