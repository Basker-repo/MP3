...
import { faFilter, faSearch, faEdit, faTrash } from "@fortawesome/free-solid-svg-icons";
          ...
          <div className="lists-container">
            <Row>
              <Col md={9}>
                <Row>
                  <Col>
                    <strong className="title">July</strong>
                    {
                      showListCard().map(item => (
                        <Card key={item.id} className="sales">
                          <Card.Body>
                            <Card.Text>
                  ...
                  <Col>
                    <strong className="title">August</strong>
                    {
                      showListCard().map(item => (
                        <Card key={item.id} className="sales">
                          <Card.Body>
                            ...
                            <Card.Text className="modal-open-link">
                              <span>
                              <FontAwesomeIcon icon={faEdit} onClick={()=>{openEdit(item)}} style={{marginRight: '5%'}}/>
                              <FontAwesomeIcon icon={faTrash}  onClick={()=>openDetails(item._id)}/>                              </span>
                            </Card.Text>
                          </Card.Body>
                        </Card>
                      ))
                  ...
                  <Col>
                    <strong className="title">September</strong>
                    {
                      showListCard().map(item => (
                        <Card key={item.id} className="sales">
                          <Card.Body>
                  ...
                  <Col>
                    <strong className="title">October</strong>
                    {
                      showListCard().map(item => (
                        <Card key={item.id} className="sales">
                          <Card.Body>
